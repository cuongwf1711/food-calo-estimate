...
DINOX_API_PATH = "/v2/task/dinox/detection"  # /v2/task/grounding_dino/detection, /v2/task/dinox/detection
DINOX_MODEL = "DINO-X-1.0"  # GroundingDino-1.6-Pro, DINO-X-1.0
